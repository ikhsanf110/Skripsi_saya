...
<!-- search form -->
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            <a href="#">
                                <i class="glyphicon glyphicon-book"></i> <span>Bank</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="bank.php"><i class="fa fa-angle-double-right"></i>Data Bank</a></li>
                                <li><a href="input-bank.php"><i class="fa fa-angle-double-right"></i>Tambah Bank</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="treeview">
                            <a href="#">
                                <i class="glyphicon glyphicon-user"></i> <span>Customer</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
