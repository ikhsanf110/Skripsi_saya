        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
           ...
           <!-- /.row -->
                  ...
                  <thead>
                    ...
                    <td><center><?php echo $data['id_bank'];?></center></td>
                    <td><center><?php echo $data['nama_bank']; ?></center></td>
                    <td><center><?php echo $data['no_rek']; ?></center></td>
                    <td><center><?php echo $data['nasabah']; ?></center></td>
