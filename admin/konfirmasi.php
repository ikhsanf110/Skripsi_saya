        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
           ...
           <!-- /.row -->
                  ...
                  <thead>
                    ...
                    <a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Konfirmasi" href="edit-konfirmasi.php?hal=edit&kode=<?php echo $data['id_kon'];?>"><span class="glyphicon glyphicon-edit"></span><!--</a> <a onclick="return confirm ('Yakin hapus Konfirmasi <?php echo $data['nopo'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Konfirmasi" href="konfirmasi.php?hal=hapus&kd=<?php echo $data['id_kon'];?>"><span class="glyphicon glyphicon-trash"></a>-->
                    </center></td></tr></div>
                 <?php   
              } 
              ?>
