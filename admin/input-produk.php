...
if (!empty($_FILES["nama_file"]["tmp_name"]))
{
	...
	{			
		...
		if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $gambar)) {
			$sql="INSERT INTO produk(kode,nama,jenis,harga,keterangan,gambar) VALUES
            ('$kode','$nama','$jenis','$harga','$keterangan','$gambar')";
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="input-produk.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <!--div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="bahan" type="text" id="bahan"class="form-control" autocomplete="off" placeholder="Bahan Produk" autocomplete="off" required />
                            </div>
                          </div>-->
                          ...
                          <!--div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="ukuran" type="text" id="ukuran"class="form-control" autocomplete="off" placeholder="Ukuran Produk" autocomplete="off" required />
                            </div>
                          </div>-->
                          ...
                          <!--div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="warna" type="text" id="warna"class="form-control" autocomplete="off" placeholder="Warna Produk" autocomplete="off" required />
                            </div>
                          </div>-->
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="keterangan" type="text" id="keterangan" class="form-control" autocomplete="off" placeholder="Keterangan Produk" autocomplete="off" required />
                          ...
                          <!--div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="stok" type="text" id="stok" class="form-control" autocomplete="off" placeholder="Stok Produk" autocomplete="off" required />-->
