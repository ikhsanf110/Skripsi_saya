...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Halaman Admin Maaruf Katering</title>
...
if (isset($_SESSION['start_time'])) {
    ...
    if ($elapsed_time >= $timeout) {
        session_destroy();
        echo "<script>alert('Waktu Login Anda Telah Habis!'); window.location = '$logout_redirect_url'</script>";
    }
}
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="update-produk.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <!--div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="bahan" type="text" id="bahan" value="<?php echo $row['bahan']; ?>" class="form-control" autocomplete="off" placeholder="Bahan Produk" autocomplete="off" required />
                            </div>
                          </div>-->
                          ...
                          <div class="col-sm-3">
                            ...
                            <option value="Nasi box">Nasi Kotak</option>
                            ...
                            <option value="Sepatu">Tas</option>
                          ...
                          <!--div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="ukuran" type="text" id="ukuran" value="<?php echo $row['ukuran']; ?>" class="form-control" autocomplete="off" placeholder="Ukuran Produk" autocomplete="off" required />
                            </div>
                          </div>-->
                          ...
                          <!--div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="warna" type="text" id="warna" value="<?php echo $row['warna']; ?>" class="form-control" autocomplete="off" placeholder="Warna Produk" autocomplete="off" required />
                            </div>
                          </div>-->
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="keterangan" type="text" id="keterangan" value="<?php echo $row['keterangan']; ?>" class="form-control" autocomplete="off" placeholder="Keterangan Produk" autocomplete="off" required /> 
                            </div>
                          </div>
                          ...
                          <!--div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="stok" type="text" id="stok" value="<?php echo $row['stok']; ?>" class="form-control" autocomplete="off" placeholder="Stok Produk" autocomplete="off" required />  
                            </div>
                          </div>-->
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Foto Baru</label>
                              <div class="col-sm-3">
