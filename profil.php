...
<body>
	...
	<div id="wrapper">
    	...
    	<div class="container">
            ...
            <b>Profil Kami : </b>
            <br />
            Tiani_Olshop adalah suatu wirausaha toko online penjualan fashion yang sudah lama berdiri sejak tahun 2016. metode penjualan yang digunakan Tiani_Olshop adalah metode Reseller artinya menjual kembali barang yang sudah di beli dengan stok barang ready artinya siap di jual, Dropshipper artinya menjual kembali barang dengan stok barang belum ready, dan PO (Pre-Order) artinya mengumpulkan pesananan dari konsumen dengan waktu yang di tentukan pihak toko, kemudian di pesankanlah pada pihak ke tiga.<br />
					...
					<div class="span6">
						<div class="icons-box-vert">
							...
							<div class="icons-box-vert-info">
								...
								<p>Kami memberikan kualitas terbaik dalam produk kami, Karena menurut kami kepuasan pelanggan adalah tujuan utama kami.
							</div>
							<div class="clear"></div>
						</div>
					</div>
